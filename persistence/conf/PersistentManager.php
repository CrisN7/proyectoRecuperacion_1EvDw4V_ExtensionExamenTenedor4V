...
class PersistentManager {
  ...
  //Get de la conexión
  //CRIS: Esta condición verifica si la propiedad estática self::$instance no es una instancia de la clase actual (self). Si no lo es, significa que aún no se ha creado la instancia única. self::$instance es la propiedad estática que almacena la instancia única de la clase.
